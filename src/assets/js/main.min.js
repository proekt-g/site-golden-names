...
"use strict";document.onreadystatechange=function(){"interactive"===document.readyState&&$(window).width()<=1200&&($(".broadcast").prepend($(".broadcast__main-video")),$(".broadcast__main-team").appendTo($(".broadcast")))},$(window).on("load",function(){function r(){var a=parseInt(document.documentElement.clientWidth),r=parseInt(window.innerWidth)-a;$("body").css({"padding-right":"".concat(r,"px")}),$("body").toggleClass("block")}function e(){r(),$(".modal-overlay").removeClass("modal-overlay--active"),$(".modal").removeClass("modal--active")}function a(){$(this).parents(".program__card").children(".program__card-note").toggleClass("program__card-note--active")}function o(){$(this).parents(".program__card").find(".program__card-modal-avatar-img").attr("src",$(this).find(".program__card-img").attr("src")),$(this).parents(".program__card").find(".program__card-modal-name").text($(this).data("avatarName")),$(this).parents(".program__card").find(".program__card-modal-text").text($(this).data("avatarInfo")),$(this).parents(".program__card").find(".program__card-modal").toggleClass("program__card-modal--active"),$(this).find(".program__card-img").toggleClass("program__card-img--hidden")}$(".menu__burger").on("click",function(){$(".placeholder-picture").toggleClass("placeholder-picture--hidden"),$(".menu").toggleClass("menu--open"),$("body").toggleClass("block")}),$(".concept__button").on("click",function(a){r(),$(".modal-overlay").toggleClass("modal-overlay--active"),$(".modal").toggleClass("modal--active")}),$(".modal__close").on("click",e),$(".modal-overlay").on("click",function(a){$(a.target).hasClass("modal-overlay--active")&&e()}),$(".program__card-read").on("click",a),$(".program__card-note-close").on("click",a),$(".program__card-speaker-avatar").on("focus",o),$(".program__card-moder-avatar").on("focus",o),$(".program__card-speaker-avatar").on("blur",o),$(".program__card-moder-avatar").on("blur",o),$(window).on("scroll",function(){pageYOffset?($(".header").addClass("header--scroll"),$(".menu__desktop").addClass("menu__desktop--scroll")):($(".header").removeClass("header--scroll"),$(".menu__desktop").removeClass("menu__desktop--scroll"))}),$('a[href^="#"]').on("click",function(a){if("#"!==String(this).slice(-1)){a.preventDefault();var r=$(this).attr("href"),e=$(r).offset().top;$("html, body").animate({scrollTop:e-60},1e3)}}),$(window).width()<=900&&$(".header__button").appendTo(".menu__desktop"),900<=$(window).width()&&OverlayScrollbars(document.querySelectorAll(".program__card-note-text"),{}),pageYOffset?($(".header").addClass("header--scroll"),$(".menu__desktop").addClass("menu__desktop--scroll")):($(".header").removeClass("header--scroll"),$(".menu__desktop").removeClass("menu__desktop--scroll"));var t=0;$(".swiper-slide").each(function(a,r){t+=$(r).width(),t+=parseInt($(r).css("margin-right"))}),$(".swiper-container").width()<=t?new Swiper(".swiper-container",{spaceBetween:30,slidesPerView:"auto",grabCursor:!0,navigation:{nextEl:".partners__slider-arrow--right",prevEl:".partners__slider-arrow--left"}}):$(".swiper-slide").each(function(a,r){$(r).css("margin-right","30px")}),$(".broadcast__main-video").attr("src",$(".broadcast__main-video").attr("src")+"?autoplay=1")});
//# sourceMappingURL=data:application/json;charset=utf8;base64,
